...
let textError = document.querySelector(".errorPassword");
...
inputs.forEach((input) => {
  input.addEventListener("input", () => {
    input.name === "name" ? validationInput(input, true)
...
btnSubmit.onclick = (e) => {
  ...
  if(passw.value!==passwConfirm.value && btnSubmit.innerHTML === NAME_SIGNUP){
